...
struct BST {
		...
		//Print content of every node according the order chosen
		void displayAscending(BTNode*, ostream&);
		void displayDescending(BTNode*, ostream&);
		bool display(int, int);

		//Print cloned subtree
		BTNode* CloneSubtree2(BTNode*);
		...
		//Print every [ath in tree
		bool printPath();
		void printPath2(BTNode*,string);
};
